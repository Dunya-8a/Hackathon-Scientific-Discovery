...
3. Use an INDEPENDENT, deterministic RNG per n_train (e.g. random.Random(3000+n_train)) so a given
   n_train yields identical numbers as the primary metric and in the sweep.
